...
/**
 * Manages generation of {@link EventListener} instances from a {@link SubscribeEventWrapper} method,
...
public class EventListenerFactory {
	...
	private static final String HANDLER_FUNC_DESC = Type.getMethodDescriptor(Type.VOID_TYPE, Type.getType(EventWrapper.class));
	private static final String INSTANCE_FUNC_DESC = Type.getMethodDescriptor(Type.VOID_TYPE, Type.getType(Object.class), Type.getType(EventWrapper.class));

	private static final MethodType STATIC_HANDLER = MethodType.methodType(void.class, EventWrapper.class);
	private static final MethodType INSTANCE_HANDLER = MethodType.methodType(void.class, Object.class, EventWrapper.class);
