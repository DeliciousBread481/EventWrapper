...
public interface IEventBus {
     ...
     *     <dd>Scanned for <em>non-static</em> methods annotated with {@link SubscribeEventWrapper} and creates listeners for
     ...
     *
     * Use this method when one of the other methods fails to determine the concrete {@link EventWrapper} subclass that is
