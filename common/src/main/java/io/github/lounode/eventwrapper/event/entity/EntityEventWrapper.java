...
public abstract class EntityEventWrapper extends EventWrapper {
	...
	public static class EnteringSection extends EntityEventWrapper {
		...
		/**
		 * A packed version of the old section's position. This is to be used with the various methods in
		 * {@link SectionPos},
		...
		/**
		 * A packed version of the new section's position. This is to be used with the various methods in
		 * {@link SectionPos},
		 * such as {@link SectionPos#of(long)} or {@link SectionPos#x(long)} to avoid allocation.
		 * 
