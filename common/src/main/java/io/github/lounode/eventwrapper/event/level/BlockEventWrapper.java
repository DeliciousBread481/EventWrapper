...
import io.github.lounode.eventwrapper.utils.ToolActions;
import io.github.lounode.xplatform.platform.support.CrossPlatform;

@CrossPlatform
public class BlockEventWrapper extends EventWrapper {
	...
	public Object toForgeEvent() {
		return new BlockEvent(getLevel(), getPos(), getState());
	}
	/// EventWrapper End
	...
	@CrossPlatform
	@Cancelable
	public static class BreakEvent extends BlockEventWrapper {
		...
		public BreakEvent(Level level, BlockPos pos, BlockState state, Player player) {
			...
			if (state == null || !EventsWrapper.getInstance().getHelper().isCorrectToolForDrops(state, player)) // Handle empty block or player unable to break block scenario
			{
				this.exp = 0;
			} else {
	...
	@CrossPlatform
	@Cancelable
	public static class EntityPlaceEvent extends BlockEventWrapper {
	...
	@CrossPlatform
	@Cancelable
	public static class EntityMultiPlaceEvent extends BlockEventWrapper.EntityPlaceEvent {
	...
	@CrossPlatform
	@Cancelable
	public static class NeighborNotifyEvent extends BlockEventWrapper {
	...
	@CrossPlatform
	@HasResult
	public static class CreateFluidSourceEvent extends EventWrapper {
	...
	@CrossPlatform
	@Cancelable
	public static class FluidPlaceBlockEvent extends BlockEventWrapper {
	 ...
	 */
	@CrossPlatform
	public static class CropGrowEvent extends BlockEventWrapper {
	...
	@CrossPlatform
	@Cancelable
	public static class FarmlandTrampleEvent extends BlockEventWrapper {
	...
	@CrossPlatform
	@Cancelable
	public static class PortalSpawnEvent extends BlockEventWrapper {
	 ...
	 * <p>
	 * Care must be taken to ensure level-modifying events are only performed if {@link #isSimulated()} returns
	 * {@code false}.
	 * <p>
	...
	@CrossPlatform
	@Cancelable
	public static class BlockToolModificationEvent extends BlockEventWrapper {
