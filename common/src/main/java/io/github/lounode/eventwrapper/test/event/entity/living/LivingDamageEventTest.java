...
public class LivingDamageEventTest implements EventTest {
    static final String BATCH = "event-entity-living-LivingDamageEventWrapper";
    ...
    public static void onLivingAttack(LivingDamageEventWrapper wrapper) {
        if (listen) {
