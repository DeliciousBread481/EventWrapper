 ...
 */
@Cancelable
public class PlayLevelSoundEventWrapper extends EventWrapper {
	...
	public PlayLevelSoundEventWrapper(@NotNull Level level, @NotNull Holder<SoundEvent> sound, @NotNull SoundSource source, float volume, float pitch) {
		this.level = level;
		this.sound = sound;
		this.source = source;
	...
	/**
	 * PlayLevelSoundEvent.AtEntity is fired when a sound is played on the {@link Level} at an {@link Entity Entity}'s
	 * position.
	 * This event is fired from {@link Level#playSound}, {@link Level#playSeededSound}, and
	 * {@link LocalPlayer#playSound}.
	 * <p>
	 * This event is {@link Cancelable cancelable}.
	 * If this event is canceled, the sound is not played.
	 * <p>
