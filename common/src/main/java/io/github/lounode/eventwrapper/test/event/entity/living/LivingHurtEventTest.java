...
public class LivingHurtEventTest implements EventTest {

    static final String BATCH = "event-entity-living-LivingHurtEventWrapper";
    ...
    public static void onLivingAttack(LivingHurtEventWrapper wrapper) {
        if (listen) {
