...
public class MobEffectEventWrapper extends LivingEventWrapper {
	...
	public static class Remove extends MobEffectEventWrapper {
		...
		/**
		 * @return the {@link MobEffectInstance}. In the remove event, this can be null if the entity does not have a
		 *         {@link MobEffect} of the right type active.
		 */
		@Override
		@Nullable
		public MobEffectInstance getEffectInstance() {
	 ...
	 * {@link Result#DEFAULT DEFAULT} will run vanilla logic to determine if this mob effect is applicable in
	 * {@link LivingEntity#canBeAffected}.
	 */
	@HasResult
	...
	public static class Added extends MobEffectEventWrapper {
		...
		/**
		 * @return the added {@link MobEffectInstance}. This is the unmerged MobEffectInstance if the old
		 *         MobEffectInstance is not null.
		 */
		@Override
		@NotNull
		public MobEffectInstance getEffectInstance() {
		...
		/**
		 * @return the old {@link MobEffectInstance}. This can be null if the entity did not have an effect of this kind
		 *         before.
		 */
		@Nullable
